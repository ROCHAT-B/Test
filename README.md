# Evidian SafeKit - High Availability Cluster with Synchronous Replication and Failover in Azure
...
## A single click to install a high availability cluster with real-time replication and failover in Azure

### Single click to deploy an Azure template
...
*   click on "I agree..." and then on "Purchase" (no fee on SafeKit, only on Azure infrastructure)
